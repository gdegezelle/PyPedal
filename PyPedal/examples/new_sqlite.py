...
options["pedfile"] = "textstream.ped"
...
if __name__ == "__main__":
    ...
    pedstream = "a1,s1,d1\na2,s2,d2\na3,a1,a2\n"
    test = pyp_newclasses.load_pedigree(
        options, pedsource="textstream", pedstream=pedstream
    )

    test.kw["database_name"] = "test_pypedal_save"
    test.kw["database_file"] = "test_pypedal_save.db"
    test.kw["database_table"] = "test"
    test.savedb(drop=True)

    test2 = pyp_newclasses.load_pedigree(options, pedsource="db")
