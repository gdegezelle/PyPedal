...
if __name__ == "__main__":
    ...
    for i in range(1):
        ...
        pyp_graphics.draw_pedigree(
            example, gfilename=_gfn, gtitle=_gt, gformat="ps", garrow=0, gclusters=0
        )
        ...
        # pyp_network.dyad_census is not supported on the current
        # NetworkX-backed 4.0 path (NetworkX 3 has no dyad_census
        # equivalent). See docs/manual/limitations.md.
