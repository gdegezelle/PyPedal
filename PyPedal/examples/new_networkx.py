...
try:
    ...
    logging.error(
        "The networkx module could not be imported in pyp_network.  Routines using networkx functionality are not available."
    )
...
if __name__ == "__main__":
    ...
    example = pyp_newclasses.load_pedigree(options_file="new_networkx.ini")
    ...
    example2 = pyp_newclasses.load_pedigree(
        options, pedsource="graph", pedgraph=ng, debug_load=True
    )
